...
![Octree Cover Photo](img/octree-cover.png){width=100%}
...
![Octree Nested Diagram](img/octree-nested-structure-diagram.png){width=50%}
...
![Octree Schematic (source: WhiteTimberwolf)](img/octree-schematic.png){width=75%}

An important consideration here is that `octrees` do not store any data themselves- they are just used to quickly query data in a space. An `Octree` is used to answer the question- "Which objects in my scene are physically close to my area of interest"? In Video Games, this may be used for player - object interactions.
...
![Octree Game map example](img/octree-game-map-example.png){width=100%}
...
![KNN Implementation Example (source: Anthony Baum)](img/KNN-algorithm-visual.png){width=50%}
...
![LOD Control Model](img/first-working-lod-model.gif){width=100%}
...
![Gameplay Example (source: Nvidia)](img/gameplay-gif.gif){width=70%}
...
![L1 Octree splitting](img/Octree-splitting-l1.png){width=70%}
...
![L2 Octree splitting](img/octree-splitting-l2.png){width=90%}
...
![Octree Recalculation on Movement](img/octree-main-hi-res.gif){width=100%}
...
![Octree Numpy Simulation](img/octree-numpy-simulation.png){width=70%}
...
![Results of LOD Model](img/refined-lod-model.gif){width=100%}

[See a lightweight visualization of real time Octree rendering](https://suryashch.github.io/octree/).
...
![KNN Algorithm Using Octree Querying](img/KNN-algorithm-using-octree.png){width=70%}
...
[Octree Visualizer](https://suryashch.github.io/octree/)
